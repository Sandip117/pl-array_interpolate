...
from array_interpolation.array_interpolation import Array_interpolation


class Array_interpolationTests(TestCase):
    """
    Test Array_interpolation.
    """
    def setUp(self):
        self.app = Array_interpolation()
